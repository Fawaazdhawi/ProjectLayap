  ...
  tabs: [
    {
      id: 'collaboration',
      label: 'Collaboration',
      content: 'Our team is the best of the best. Collaboration isn\'t just about working together, but also about working in a structured and efficient manner.',
      image: '/images/Kondisi_lab3.jpg',
    },
    {
      id: 'innovation',
      label: 'Innovation',
      content: 'Our values on innovation is everything we do. How we provide our services to our clients, our employees and to the people we serve in every way. We believe that innovation is a key to success for every one.',
      image: '/images/Kondisi_lab2.jpg',
    },
    {
      id: 'advanced-technology',
      label: 'Advanced Technology',
      content: 'Our technology is proof that we are serious. With our sophistication, we can support all elements of society.',
      image: '/images/Kondisi_lab1.jpg',
    },
  ],
};
...
export const teamData = {
  ...
  teamTeaching: [
    { image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face', name: 'Dr. Ahmad Fuad Rahman, S.T., M.T.', role: 'Dosen Pengampu' },
    { image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face', name: 'Dr. Surya Sumpeno, S.T., M.Sc.', role: 'Dosen Pengampu' },
    { image: 'https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?w=300&h=300&fit=crop&crop=face', name: 'Prof. Dr. Mauridhi Hery Purnomo, M.Eng.', role: 'Dosen Pengampu' },
    { image: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&h=300&fit=crop&crop=face', name: 'Prof. Dr. I Ketut Eddy Purnama, S.T., M.T.', role: 'Dosen Pengampu' },
    { image: 'https://images.unsplash.com/photo-1494790108755-2616b5710000?w=300&h=300&fit=crop&crop=face', name: 'Dr. Susi Juniastuti, S.T.,M.Eng.', role: 'Dosen Pengampu' },
    { image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop&crop=face', name: 'Arta Kusuma Hernanda, S.T., M.T..', role: 'Dosen Pengampu' },
  ],
  teamTeachingDescription: 'Tim pengajar yang berpengalaman dalam bidang telematika dan multimedia cerdas, yang berkomitmen untuk memberikan pendidikan berkualitas tinggi dan membimbing mahasiswa dalam pengembangan teknologi terdepan.',
};
